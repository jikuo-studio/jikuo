...
class StudioWebServerTests(unittest.TestCase):
    ...
    def test_index_html_is_no_write_control_shell_with_document_rules_preview(self):
        ...
        self.assertIn("Latest runtime turn", html)
        ...
        self.assertIn('traceChip("Gaps", detailCount(gapCount, "items"))', html)
        self.assertIn('traceChip("Unchecked applicability"', html)
