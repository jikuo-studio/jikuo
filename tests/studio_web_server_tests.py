...
class StudioWebServerTests(unittest.TestCase):
    ...
    def test_index_html_is_no_write_control_shell_with_document_rules_preview(self):
        ...
        self.assertIn("Studio map", html)
        self.assertIn('aria-label="Studio module navigation"', html)
        self.assertIn('href="#overview"', html)
        self.assertIn('href="#policy-trace-section"', html)
        self.assertIn('href="#document-trace-section"', html)
        self.assertIn('href="#policy-configuration-section"', html)
        self.assertIn('href="#project-files-title"', html)
        self.assertIn('href="#policy-starter-init-section"', html)
        self.assertIn('href="#policy-evolution-section"', html)
        self.assertIn('href="#policy-template-publication-section"', html)
        self.assertIn('href="#policy-template-activation-section"', html)
        self.assertIn('href="#policy-candidate-activation-section"', html)
        ...
        self.assertIn("Current Limitations", html)
        self.assertIn("release-limitations-status", html)
        ...
        self.assertIn('id="work-receipt-overview"', html)
        self.assertIn('document.getElementById("overview-metrics")', html)
        self.assertIn('document.getElementById("work-receipt-overview")', html)
        self.assertIn("renderWorkReceiptOverview", html)
        self.assertIn("work_receipt_checkpoints", html)
        self.assertIn("checkpointStatusLabel", html)
        self.assertIn("Work receipt", html)
        ...
        self.assertIn("record.resolution || {}", html)
        self.assertIn("record.resolution_bucket", html)
        self.assertIn("resolution.action_boundary", html)
        self.assertNotIn('value.includes("starter policy pack")', html)
        self.assertNotIn('value.includes("jikuo install")', html)
        ...
        self.assertIn("policy-starter-init-section", html)
        ...
        self.assertIn("policy-evolution-section", html)
        ...
        self.assertIn("policy-template-publication-section", html)
        self.assertIn("policy-template-activation-section", html)
        self.assertIn("policy-candidate-activation-section", html)
        self.assertIn("policy-inventory-section", html)
        ...
        self.assertNotIn("Available Actions", html)
        self.assertNotIn("<h2>Diagnostics</h2>", html)
        self.assertNotIn('id="actions"', html)
        self.assertNotIn('id="diagnostics"', html)
        self.assertNotIn('document.getElementById("actions")', html)
        self.assertNotIn('document.getElementById("diagnostics")', html)
