...
2. Plan strict mounted harness entry after the router exists, using Agent SDK wrappers, local proxy / Studio entry, or client hooks as adapters rather than kernel logic.
