...
4. Plan `JIKUO-ONBOARD-01` package-first non-engineer onboarding: install package -> run CLI setup -> configure client MCP -> verify runtime card, without making Python `import` the user entry.
