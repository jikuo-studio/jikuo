...
- `JIKUO-MCP-01` Stage A desktop smoke is accepted as user-verified on 2026-05-15 for Codex Desktop and Claude Desktop; Stage B guarded-write tools remain blocked until explicit user acceptance
